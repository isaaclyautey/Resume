...
\geometry{margin={1cm},top=0.5cm} % Adjust the margin size - horizontal whitespace
...
\begin{center} % Center everything in the document
	...
	\begin{tabularx}{0.97\linewidth}{XX}
		...
		\begin{itemize}\setlength\itemsep{0em}
			...
			\begin{sloppypar}
				Lead 2 Six Sigma teams, the first tackling a printing process focusing on improving OEE by reducing scrap and non-value-added material use (YOY >110k); The second team tackled productivity discrepancies between generations of forming equipment leading to large gains in sharing of ideas. (YOY >76k)
			\end{sloppypar}
	...
	\begin{tabularx}{0.97\linewidth}{X|X}
		{\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
			 ...
			 \end{tabularx}} &
		{\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
					 Manufacturing & Statistical Process Control, Dimensional Inspection, In-line defect detection \& classification, Web Guidance, Conveyance \\
